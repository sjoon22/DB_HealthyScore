...
# 모델을 사용한 예측
new_data['DIS_predicted'] = knn.predict(X_new_pca)

# 예측된 'DIS' 값이 포함된 새 데이터셋을 저장
new_data.to_csv('C:/Users/82102/Desktop/전주시/건강검진정보_DIS_predict.csv', index=False, encoding='cp949')
